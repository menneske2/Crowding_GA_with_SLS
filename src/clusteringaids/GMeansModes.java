 ...
 * @author Haifeng Li
 */
public class GMeansModes extends CentroidClustering<double[], double[]> {
     ...
     */
    public GMeansModes(double distortion, double[][] centroids, int[] y) {
     ...
     */
    public static GMeansModes fit(double[][] data, int kmax) {
     ...
     */
    public static GMeansModes fit(double[][] data, int kmax, int maxIter, double tol) {
        if (kmax < 2) {
        ...
        return new GMeansModes(distortion, centroids, y);
    }
