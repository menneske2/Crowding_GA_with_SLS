 ...
 * @author Haifeng Li
 */
public class DeterministicAnnealing2 extends CentroidClustering<double[], double[]> {
     ...
     */
    public DeterministicAnnealing2(double distortion, double[][] centroids, int[] y) {
     ...
     */
    public static DeterministicAnnealing2 fit(double[][] data, int Kmax) {
        return fit(data, Kmax, 0.8, 10, 1E-4, 1E-2);
    }
     ...
     */
    public static DeterministicAnnealing2 fit(double[][] data, int Kmax, double alpha, int maxIter, double tol, double splitTol) {
        ...
        return new DeterministicAnnealing2(distortion, centroids, y);
    }
